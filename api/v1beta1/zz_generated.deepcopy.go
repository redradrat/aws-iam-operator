...
func (in *GroupSpec) DeepCopyInto(out *GroupSpec) {
	*out = *in
	...
	if in.UserReferences != nil {
		in, out := &in.UserReferences, &out.UserReferences
...
func (in *GroupStatus) DeepCopyInto(out *GroupStatus) {
	*out = *in
	out.AWSObjectStatus = in.AWSObjectStatus
	if in.UsersAdded != nil {
		in, out := &in.UsersAdded, &out.UsersAdded
		*out = make([]v1.ObjectReference, len(*in))
		copy(*out, *in)
	}
}
...
func (in *UserStatus) DeepCopyInto(out *UserStatus) {
	*out = *in
	out.AWSObjectStatus = in.AWSObjectStatus
	out.LoginProfileSecret = in.LoginProfileSecret
	out.ProgrammaticAccessSecret = in.ProgrammaticAccessSecret
}
